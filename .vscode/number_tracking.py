...
class DetectedNumber:
    def __init__(self, centerX, centerY, id, value, height):
    ...
    def update_coordinates(self, centerX, centerY, height):
        self.centerX = centerX
        self.centerY = centerY
        self.height = height
...
def distance_from_line(detected_number, first_point, second_point):
    x0 = detected_number.centerX; y0 = detected_number.centerY
